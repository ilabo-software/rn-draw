...
const Canvas = /*#__PURE__*/(0, _react.forwardRef)((_ref, ref) => {
  ...
  const pathPaint = _reactNativeSkia.Skia.Paint();
  (0, _utils.setPaint)(pathPaint, {
    color,
    thickness,
    opacity,
    filled,
  ...
  (0, _react.useEffect)(() => onPathsChange && onPathsChange((0, _utils.convertInnerPathsToStandardPaths)(paths)), [paths, onPathsChange]);
