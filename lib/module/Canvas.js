import React, { useImperativeHandle, useMemo, useRef, forwardRef, useCallback, useEffect } from 'react';
import { StyleSheet } from 'react-native';
import { Skia, useDrawCallback, useTouchHandler, PaintStyle, SkiaView } from '@shopify/react-native-skia';
...
const Canvas = /*#__PURE__*/forwardRef((_ref, ref) => {
  ...
  }, [canvasPaint, pathPaint, eraserPaint, eraserPoint, eraserSize, paths, touchDisabled, shareStrokeProperties]);
  useEffect(() => onPathsChange && onPathsChange(convertInnerPathsToStandardPaths(paths)), [paths, onPathsChange]);
